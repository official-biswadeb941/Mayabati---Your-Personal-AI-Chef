document.addEventListener("DOMContentLoaded", function() {
    ...
    $(document).ready(function() {
        ...
        // Handle microphone button click event
        ...
        function startSpeechRecognition() {
          var recognition = new webkitSpeechRecognition(); // Initialize SpeechRecognition
          ...
          recognition.onresult = function(event) {
            ...
            for (var i = event.resultIndex; i < event.results.length; i++) {
              // Append transcript of each result
              transcript += event.results[i][0].transcript;
            }
      
            // Display transcript in the chat interface
            handleMessage(transcript.trim());
          };
        ...
        // Function to handle incoming message from speech recognition
        function handleMessage(message) {
          // Display the recognized speech in the chat interface
